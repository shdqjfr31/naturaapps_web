...
$config['templates']        = $config['assets'] . 'templates/NiceAdmin/';
$config['templatesCore']        = $config['assets'] . 'templates/';
$config['datatables']        = $config['assets'] . 'templates/DataTables/DataTables-1.12.1/';
$config['datatablesCore']        = $config['assets'] . 'templates/DataTables/';


//Setingan Judul & Footer Web
$config['web_title']    = "JafarScript";
$config['web_footer']    = "Copyright &copy;Powered by JafarScript 2022";
